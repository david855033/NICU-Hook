...
var fakeserverData=[
    ...
    \
        ...
        <tbody>\
    \
    <tr><td style="width:20px"><a href="qemr.cfm?action=findEmr&histno=43977748&ward=NICU-1" id="43977748" class="clickmenu01">查</a></td><td id="tips"><a class="tooltip" href="#">NICU-  1<span>1.DRG群組代碼:N19  <BR>2.DRG落點:A<BR>3.住院天數差額 :<font color="red">+16  </font><BR>4.健保給付差額:<font color="green">+0</font></span></a></td><td> <font color="red">@</font><font color="green"></font>廖立欣 <a href="#"  onclick="javascript:window.open("qemr.cfm?action=findIsol&histno=43977748&caseno=22477040","isol", "height=40,width=60,left=400,top=200,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,status=no,titlebar=yes,location=no", true).focus()"><font color="green"></font></a></td><td>43977748  </td><td>女</td><td>NBD &nbsp;</td><td id="tips"><a class="tooltip" href="#">A<span>1.DRG群組代碼:N19  <BR>2.DRG落點:A<BR>3.住院天數差額 :<font color="red">+16  </font><BR>4.健保給付差額:<font color="green">+0</font></span></a>&nbsp;</td><td>20170808&nbsp;</td></tr>\
    \
    <tr><td style="width:20px">&nbsp;</td><td>NICU-  2</td><td colspan="6">空床</td></tr>\
    \
    <tr><td style="width:20px">&nbsp;</td><td>NICU-  3</td><td colspan="6">空床</td></tr>\
    \
    <tr><td style="width:20px"><a href="qemr.cfm?action=findEmr&histno=44052031&ward=NICU-5" id="44052031" class="clickmenu01">查</a></td><td id="tips"><a class="tooltip" href="#">NICU-  5<span>1.DRG群組代碼:N10  <BR>2.DRG落點:A<BR>3.住院天數差額 :<font color="">     </font><BR>4.健保給付差額:<font color="green">+0</font></span></a></td><td> <font color="red">@</font><font color="green"></font>謝淑雅之女 <a href="#"  onclick="javascript:window.open("qemr.cfm?action=findIsol&histno=44052031&caseno=22502289","isol", "height=40,width=60,left=400,top=200,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,status=no,titlebar=yes,location=no", true).focus()"><font color="green"></font></a></td><td>44052031  </td><td>女</td><td>NBD &nbsp;</td><td id="tips"><a class="tooltip" href="#">A<span>1.DRG群組代碼:N10  <BR>2.DRG落點:A<BR>3.住院天數差額 :<font color="">     </font><BR>4.健保給付差額:<font color="green">+0</font></span></a>&nbsp;</td><td>20170815&nbsp;</td></tr>\
    \
    <tr><td style="width:20px"><a href="qemr.cfm?action=findEmr&histno=44051210&ward=NICU-6" id="44051210" class="clickmenu01">查</a></td><td id="tips"><a class="tooltip" href="#">NICU-  6<span>1.DRG群組代碼:24101<BR>2.DRG落點:A<BR>3.住院天數差額 :<font color="red">+0   </font><BR>4.健保給付差額:<font color="green">+0</font></span></a></td><td> <font color="red">@</font><font color="green"></font>阮怡菁之女 <a href="#"  onclick="javascript:window.open("qemr.cfm?action=findIsol&histno=44051210&caseno=22533918","isol", "height=40,width=60,left=400,top=200,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,status=no,titlebar=yes,location=no", true).focus()"><font color="green"></font></a></td><td>44051210  </td><td>女</td><td>NBD &nbsp;</td><td id="tips"><a class="tooltip" href="#">A<span>1.DRG群組代碼:24101<BR>2.DRG落點:A<BR>3.住院天數差額 :<font color="red">+0   </font><BR>4.健保給付差額:<font color="green">+0</font></span></a>&nbsp;</td><td>20170825&nbsp;</td></tr>\
    \
    <tr><td style="width:20px"><a href="qemr.cfm?action=findEmr&histno=44051798&ward=NICU-7" id="44051798" class="clickmenu01">查</a></td><td id="tips"><a class="tooltip" href="#">NICU-  7<span>1.DRG群組代碼:N17  <BR>2.DRG落點:D<BR>3.住院天數差額 :<font color="red">+18  </font><BR>4.健保給付差額:<font color="green">+0</font></span></a></td><td> <font color="red">@</font><font color="green"></font>陳科羽 <a href="#"  onclick="javascript:window.open("qemr.cfm?action=findIsol&histno=44051798&caseno=22458119","isol", "height=40,width=60,left=400,top=200,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,status=no,titlebar=yes,location=no", true).focus()"><font color="green"></font></a></td><td>44051798  </td><td>男</td><td>NBD &nbsp;</td><td id="tips"><a class="tooltip" href="#">D<span>1.DRG群組代碼:N17  <BR>2.DRG落點:D<BR>3.住院天數差額 :<font color="red">+18  </font><BR>4.健保給付差額:<font color="green">+0</font></span></a>&nbsp;</td><td>20170803&nbsp;</td></tr>\
    \
    ...
    \
    <tr><td style="width:20px"><a href="qemr.cfm?action=findEmr&histno=44124789&ward=NICU-11" id="44124789" class="clickmenu01">查</a></td><td id="tips"><a class="tooltip" href="#">NICU- 11<span>1.DRG群組代碼:41702<BR>2.DRG落點:D<BR>3.住院天數差額 :<font color="red">+11  </font><BR>4.健保給付差額:<font color="green">+0</font></span></a></td><td> <font color="red">@</font><font color="green"></font>曾佳慧之女 <a href="#"  onclick="javascript:window.open("qemr.cfm?action=findIsol&histno=44124789&caseno=22484582","isol", "height=40,width=60,left=400,top=200,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,status=no,titlebar=yes,location=no", true).focus()"><font color="green"></font></a></td><td>44124789  </td><td>女</td><td>NBD &nbsp;</td><td id="tips"><a class="tooltip" href="#">D<span>1.DRG群組代碼:41702<BR>2.DRG落點:D<BR>3.住院天數差額 :<font color="red">+11  </font><BR>4.健保給付差額:<font color="green">+0</font></span></a>&nbsp;</td><td>20170810&nbsp;</td></tr>\
    \
